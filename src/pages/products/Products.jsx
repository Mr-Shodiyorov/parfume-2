          ...
          {!isLoading && maxPrice > minPrice && (
            <div className="prd-filterBlock">
              ...
              <div className="prd-priceValues">
                <span>{formatMoney(activeMin)}</span>
                <span>{formatMoney(activeMax)}</span>
              </div>
                ...
                <article key={p.id} className="prd-card">
                  ...
                  <div className="prd-cardBody">
                    ...
                    <div className="prd-priceRow">
                      <span className="prd-priceMain">{formatMoney(price)}</span>
                      {showOld && <span className="prd-priceOld">{formatMoney(old)}</span>}
                    </div>
